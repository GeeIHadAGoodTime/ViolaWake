 ...
 */
// Use `any` for the Env generic to avoid type conflicts between the Env type alias
// and McpAgent's `Env extends Cloudflare.Env` constraint (same pattern as EmailAgent).
