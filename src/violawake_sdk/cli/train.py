...
def main() -> None:
    ...
    parser.add_argument("--positive-dir", required=True, metavar="DIR",
                        help="Directory containing positive WAV samples")
    parser.add_argument("--negative-dir", metavar="DIR",
                        help="Directory containing negative WAV samples (optional)")
    parser.add_argument("--output-model", required=True, metavar="PATH",
